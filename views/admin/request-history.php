...
$requests=$conn->getAll("SELECT rq.MSR as msr, nv.Ten as ten, rq.Loai_Request as loai, rq.Ly_Do as lydo, rq.Trang_Thai as trangThai FROM `request` as rq JOIN `nhanvien` as nv ON rq.MSNV = nv.MSNV WHERE Trang_Thai = 'Request Approval' OR Trang_Thai = 'Done';");
