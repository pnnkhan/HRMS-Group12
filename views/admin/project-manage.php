...
$projects=$conn->getAll("select da.tenda, nv1.ten as quanly, ct.thoi_gian_tham_gia, ct.danh_gia
                            from nhanvien nv1 join (nhanvien nv join (chitietthamgiaduan ct join (duan da join quanlyda ql 
                            on da.msda = ql.msda) on ct.msda = da.msda) on nv.msnv = ct.msnv) on nv1.msnv = ql.msnv and nv.msnv = 1");
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        <td><?=$project['tenda']?></td>
                                        <td><?=$project['quanly']?></td>
                                        <td><?=$project['thoi_gian_tham_gia']?></td>
                                        <td><?=$project['danh_gia']?></td>
                                    </tr>
                                    <?php
                                   }
                                    ?>
